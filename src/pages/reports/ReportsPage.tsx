...
export default function ReportsPage() {
  ...
  const { data: reportsData, loading: reportsLoading, refetch: _refetchReports } = useAsync<AdminReportsResponse>(
                    ...
                    <tr key={log._id || i} className="hover:bg-gray-50 transition" style={{ borderBottom: i < visibleLogs.length - 1 ? "1px solid #f8fafc" : "none" }}>
                      ...
                      <td className="px-4 py-2.5">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs text-gray-700">{log.actorName || log.actorId || "—"}</span>
                        </div>
                      </td>
                      <td className="px-4 py-2.5">
                        <div className="flex items-center gap-1.5">
