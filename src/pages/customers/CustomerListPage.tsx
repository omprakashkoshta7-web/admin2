        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 hover:border-gray-900 transition text-sm font-semibold"
            >
              <RefreshCw size={14} />
              Refresh
            </button>
            <button
              onClick={() => {
                const csv = [
                  ['ID', 'Name', 'Email', 'Phone', 'Status', 'Risk Score', 'Lifetime Value', 'Total Orders'],
